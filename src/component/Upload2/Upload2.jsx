            ...
            <div>
                ...
                <div className=' mx-14'>
                    ...
                    <div className='flex'>
                        ...
                        <div>
                            <form className='border-1 border-gray w-60 p-10 mb-6 text-center rounded-lg' onClick={()=> document.querySelector(".input-field").click()}>
                                    ...
                                    <div className='bg-amber text-red flex justify-center w-10 h-10 ml-24 rounded-full'>
                                        <h2><FaFileUpload  className=' h-7 w-6 pt-3'/></h2>
                               ...
                               <b><label htmlFor="" className=' py-2'>Identification Type</label> <br /></b> 
                                ...
                                <div className='w-60 py-3 mt-20 text-center bg-orange-300 rounded-lg'>
